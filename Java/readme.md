...
- [Interview preparation on Java (OOP)](#interview-preparation-on-java-oop)
  ...
  - [🚀 Topics covered from javatpoint and other sources](#-topics-covered-from-javatpoint-and-other-sources)
    ...
    - [🍂 what is the purpose of having constructor in abstract class?](#-what-is-the-purpose-of-having-constructor-in-abstract-class)
    ...
    - [🍂 how to create object without using new operator?](#-how-to-create-object-without-using-new-operator)
    - [🍂 Inheritance vs composition?](#-inheritance-vs-composition)
    - [🍂 What is the difference between == and equals()?](#-what-is-the-difference-between--and-equals)
    - [🍂 Details of static class.](#-details-of-static-class)
    - [🍂 How variable is stored?](#-how-variable-is-stored)
...
### 🍂 How JVM works?
1. **Class Loader Subsystem**: loads the class files.
2. **Memory Area**: stores the data and code.
...
### 🍂 what is the purpose of having constructor in abstract class?
The purpose of having a constructor in an abstract class is to **initialize the instance variables** of the abstract class. It is used to initialize the data members of the abstract class when an object of the subclass is created. It is used to **initialize the common properties** of the subclass. Object of Abstract class can not be created so constructor of abstract class is called when object of subclass is created.
...
### 🍂 how to create object without using new operator?
We can create an object without using the `new` operator by using **reflection**. Reflection is a feature in Java that allows us to inspect and modify classes and objects at runtime.
...
public class Main {
    public static void main(String[] args) {
        try {
            Class<?> cls = Class.forName("MyClass"); // get the class object
            Constructor<?> constructor = cls.getConstructor(); // get the constructor
            MyClass obj = (MyClass) constructor.newInstance(); // create an object
            obj.display();
        } catch (Exception e) {
            System.out.println(e);
        }
...
Inheritance is a mechanism in which a new class is created by **deriving properties** from an existing class. It is used to achieve **code reusability** and **polymorphism**. It is a **"is-a"** relationship.

Composition is a mechanism in which a class contains an **object of another class**. It is used to achieve **code reusability** and **flexibility**. It is a **"has-a"** relationship.

| Feature | Inheritance | Composition |
|---------|-------------|-------------|
| **Relationship** | "is-a" relationship | "has-a" relationship |
| **Code Reusability** | Achieved by deriving properties from an existing class | Achieved by containing an object of another class |
...
The `==` operator is used to compare the **reference** of two objects. It checks if the two objects are **pointing to the same memory location**.

The `equals()` method is used to compare the **content** of two objects. It checks if the two objects have the **same content**.
...
### 🍂 Details of static class.
A static class is a class that is **associated with the class itself** rather than with any instance of the class. It is used to group related methods and fields that do not depend on the instance of the class. It is used to achieve **code organization** and **modularity**. It is declared using the `static` keyword.
...
use of static class:
1. **Code organization**: to group related methods and fields.
2. **Modularity**: to separate the functionality of the class.
3. **Encapsulation**: to hide the implementation details.
4. **Code reuse**: to reuse the code in different classes.

<br><br>

### 🍂 How variable is stored?
Variables are stored in the **memory**. The memory is divided into different segments such as **stack**, **heap**, **code**, and **data** segments. The variables are stored in the **stack** or **heap** based on their **scope** and **lifetime**.

- **Stack**: stores local variables and function calls. It is a **LIFO** data structure.
- **Heap**: stores objects and arrays. It is a **dynamic** data structure.
